...
class FruitOrderSummaryPage extends StatefulWidget {
  const FruitOrderSummaryPage({Key? key}) : super(key: key);

  @override
  State<FruitOrderSummaryPage> createState() => _FruitOrderSummaryPageState();
}

class _FruitOrderSummaryPageState extends State<FruitOrderSummaryPage> {
  @override
