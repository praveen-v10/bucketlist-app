import 'package:bucketlist/Dashboard/Grocery/grocery_payment_page.dart';
import 'package:bucketlist/Dashboard/Meat/meat_payment_page.dart';
...
import '../Food/food_payment_page.dart';

class MeatOrderSummary extends StatefulWidget {
  const MeatOrderSummary({Key? key}) : super(key: key);

  @override
  State<MeatOrderSummary> createState() => _MeatOrderSummaryState();
}

class _MeatOrderSummaryState extends State<MeatOrderSummary> {
  @override
