...
class MeatPaymentPage extends StatefulWidget {
  const MeatPaymentPage({Key? key}) : super(key: key);

  @override
  State<MeatPaymentPage> createState() => _MeatPaymentPageState();
}

class _MeatPaymentPageState extends State<MeatPaymentPage> {
