import 'package:bucketlist/Widget/order_tracking2.dart';
...
class OrderTracking1 extends StatefulWidget {
  const OrderTracking1({Key? key}) : super(key: key);

  @override
  State<OrderTracking1> createState() => _OrderTracking1State();
}
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  width: w * 0.8,
                  child: Lottie.asset('assets/lottie/order_prepare.json'),
                ),
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'We are cooking up your order,just for you!',
                        style: TextStyle(
                            color: Colors.white60,
                            fontSize: 20,
                           ),
