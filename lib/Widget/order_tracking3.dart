...
class OrderTracking3 extends StatefulWidget {
  const OrderTracking3({Key? key}) : super(key: key);

  @override
  State<OrderTracking3> createState() => _OrderTracking3State();
}

class _OrderTracking3State extends State<OrderTracking3> {
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          'From our kitchen to your doorstep, enjoy your meal',
